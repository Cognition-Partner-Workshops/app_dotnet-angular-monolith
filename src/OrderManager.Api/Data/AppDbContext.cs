...
public class AppDbContext : DbContext
{
    ...
    // InventoryItems removed — now managed by inventory-service microservice
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // InventoryItem entity configuration removed — now managed by inventory-service microservice
    }
}

...
public class AppDbContext : DbContext
{
    ...
    // InventoryItems DbSet removed — inventory is now managed by the standalone inventory microservice
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // InventoryItem entity config removed — managed by inventory microservice
    }
}

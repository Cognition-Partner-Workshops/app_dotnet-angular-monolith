...
public class AppDbContext : DbContext
{
    ...
    // InventoryItems removed — inventory is now managed by inventory-service microservice
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // InventoryItem entity removed — inventory is now managed by inventory-service microservice
    }
}

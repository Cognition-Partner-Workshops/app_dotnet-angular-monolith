...
/// <summary>
/// Lightweight DTO representing inventory data from the inventory microservice.
/// Replaces the former InventoryItem EF Core model that was removed during decomposition.
/// </summary>

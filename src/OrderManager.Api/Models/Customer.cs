...
/// </summary>
/// <remarks>
/// Each customer has a unique email address enforced at the database level.
/// A customer can be associated with multiple <see cref="Order"/>s.
/// </remarks>
public class Customer
{
    ...
    /// <summary>Gets or sets the street address portion of the customer's mailing address.</summary>
    public string Address { get; set; } = string.Empty;

    /// <summary>Gets or sets the city portion of the customer's mailing address.</summary>
    public string City { get; set; } = string.Empty;

    /// <summary>Gets or sets the state/province portion of the customer's mailing address.</summary>
    public string State { get; set; } = string.Empty;

    /// <summary>Gets or sets the postal/ZIP code of the customer's mailing address.</summary>

...
public class OrderServiceTests
{
    ...
    private static InventoryHttpClient CreateMockInventoryClient(HttpResponseMessage response)
    {
    ...
    public async Task CreateOrder_CallsInventoryService()
    {
        ...
        {
            Content = JsonContent.Create(inventoryItem)
        };
        var inventoryClient = CreateMockInventoryClient(response);
        var service = new OrderService(context, inventoryClient);

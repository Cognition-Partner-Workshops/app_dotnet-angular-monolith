...
public class OrderServiceTests
{
    ...
    private InventoryHttpClient CreateInventoryClient(HttpResponseMessage response)
    {
    ...
    public async Task CreateOrder_CallsInventoryService()
    {
        ...
        var dto = new InventoryItemDto
        {
            ...
            Sku = "SKU-001", QuantityOnHand = 45, ReorderLevel = 10,
        ...
        var inventoryClient = CreateInventoryClient(response);
        var service = new OrderService(context, inventoryClient);
    ...
    public async Task CreateOrder_ThrowsOnInsufficientStock()
    {
        ...
        var inventoryClient = CreateInventoryClient(errorResponse);
        var service = new OrderService(context, inventoryClient);

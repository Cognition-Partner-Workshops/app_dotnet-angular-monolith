...
public class OrderServiceTests
{
    ...
    public async Task GetAllOrders_ReturnsEmptyList_WhenNoOrders()
    {
        ...
        var inventoryClient = CreateInventoryClient(new FakeInventoryHandler());
    ...
    {
        using var context = CreateContext();
        var handler = new FakeInventoryHandler(stockAvailable: true);
    ...
    {
        using var context = CreateContext();
        var handler = new FakeInventoryHandler(stockAvailable: false);
        var inventoryClient = CreateInventoryClient(handler);
        var service = new OrderService(context, inventoryClient);
        var product = await context.Products.FirstAsync();
        var customer = await context.Customers.FirstAsync();

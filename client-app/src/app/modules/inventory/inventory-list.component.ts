 ...
 * Shows product name, on-hand quantity, reorder level, warehouse location, and last
 * restock date. Rows where quantity is at or below the reorder level receive the
 * `low-stock` CSS class for visual highlighting.
 */
@Component({
